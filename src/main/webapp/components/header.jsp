...
<nav class="navbar navbar-expand-lg navbar-light" id="myTopnav" style="background-color: lightblue">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/workerList"/>"><b>Про нас</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/pages/services.jsp"/>"><b>Послуги</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/products"/>"><b>Товари</b></a>
            </li>
            <li class="nav-item">
